...
export default{
    ...
    template:`
    <section class="country_header_secton uae">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="foradd">for</div><div class="country_header_secton_right_countryname">UAE</div>
        ...
        <div class="row">
            <div class="col-md-8">
                <div class="mobileapp_devcountry_bx_left">
                    <h1 class="mobileapp_devcountry_bx_left_title">Mobile App Development Company In <span>UAE</span></h1>
                    <p style="text-align: justify;">Logicspice is an award winning mobile app development company and is serving the app industry since 2006. Our team is commuted to provide best app design and user friendly layouts. We at logicspice try to transform your ideas into successful mobile apps and provide best app developemt services in Europe and all other mazor countries. Our expert app developers strive hard to develop best quality apps with offers complete End-To-End custom features.</p>
...
<section class="creativity">
    <div class="container">
        ...
        <p> Logicspice is a app development company providing customized web, android and iPhone app development solutions with best optimal designs and creativity throughout the 
            world including major cities of UAE. App developed by logicspice help businesses to enhance their brand presence, trust, loyalty among the current 
...
<section class="acquainted">
    <div class="container">
        <h3 class="mobileapp_devcountry_bx_left_title">We Have Served Our Clients In UAE</h3>
        <p>Being acquainted with latest technology & standard tools we have delivered thousands of web & mobile application to our clients in UAE and have a team of 
  ...
  <div class="ClientSlideBx">
        <div class="row">
            <div class="col-md-4">
                <img src="./../assets/img/globalpages/iTenderYou.png" alt="..." class="img-thumbnail">
      </div>
            <div class="col-md-8">
                <h4>iTenderyou</h4>
                <p>itenderyou, provides a platform for users to post items by selecting category & submitting details of auction item over the site. User as a Seller can invite 
                    other users for posting bids over the site.Users as a buyer will be able to view invites and can view details of auction over the site. Users as a buyer will be 
                    able to view details of a particular item <a href="https://www.logicspice.com/case-study/itenderyou" target="_blank">Read More..</a></p>
...
<!--                        <div class="left_side_testi">
                            ...
                            <div class="cilent_name">
                                <span><strong class="flag"><img src="./../assets/img/globalpages/uae.png"></strong> Sabdeen</span>
                        ...
                        <div class="right_side_testi">
                            ...
                            <div class="cilent_text">"Best project management experience/journey I had. Great team spirit, very flexible and understanding while maintaining time and 
                                budget target.Top tear professional communication and support."</div>    
                            <div class="cilent_name">
                                <span><strong class="flag"><img src="./../assets/img/globalpages/uae.png" alt="uae"></strong> Sabdeen</span>
    ...
    <div class="ClientSlideBx">
      <div class="row">
            <div class="col-md-4">
        <img src="./../assets/img/globalpages/CourseTakers.png" alt="..."  class="img-thumbnail">
      </div>
            <div class="col-md-8">
                <h4>Course Takers</h4>
                <p>"CourseTakers" is an interactive medium for course givers to advertise their courses and course takers can easily search for courses available on website, view 
                    their entire details and book them online by making payment online or selecting Cash on delivery option. After attending the booked course, course taker will 
                    receive an email notification to rate that <a href="https://www.logicspice.com/case-study/coursetakers/" target="_blank">Read More..</a></p>
...
<!--                        <div class="left_side_testi">
                            <div class="cilent_img"> 
                                <img src="./../assets/img/globalpages/no-img-client.png" alt="">                            </div> 
                            <div class="cilent_name">
                                <span><strong class="flag"><img src="./../assets/img/globalpages/uae.png"></strong> Emsa11</span>
                        ...
                        <div class="right_side_testi">
                            ...
                            <div class="cilent_text">
                                "The word "perfect" is not enough to describe the capability of PhpMaestro. They are just wonderful and willing to extend the effort until the customer 
                                satisfied. definitely will re-hire them"
                            </div>    
                            <div class="cilent_name">
                                <span><strong class="flag"><img src="./../assets/img/globalpages/uae.png" alt="uae"></strong> Emsa11</span>
