...
export default{
    ...
    template:`
    <section class="country_header_secton uk">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="foradd">for</div><div class="country_header_secton_right_countryname">Uk</div>
        ...
        <div class="row">
            <div class="col-md-8">
                <div class="mobileapp_devcountry_bx_left">
                    <h1 class="mobileapp_devcountry_bx_left_title">Mobile App Development Company In  <span>UK</span></h1>
                    <p style="text-align: justify;">Logicspice, the UK development company is specialized in mobile app development that puts the user’s first and deliver a great digital experience. We deliver the most successful apps that offer an outstanding user experience and business transformation result.</p>
                    <p style="text-align: justify;">Logicspice believes in constantly refining process to produce the effective apps for engaging more customers. Our developed apps have always hit the play store first. We work with the commitment to customer satisfaction and delivering the project on given time and budget..</p>
                </div>
            </div>
            <div class="col-md-4">
