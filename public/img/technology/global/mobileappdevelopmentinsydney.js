...
export default{
    ...
    template:`
<section class="country_header_secton sydney">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="foradd">for</div><div class="country_header_secton_right_countryname">Sydney</div>
        ...
        <div class="row">
            <div class="col-md-8">
                <div class="mobileapp_devcountry_bx_left">
                    <h1 class="mobileapp_devcountry_bx_left_title">Mobile App Development Company In <span>Sydney</span></h1>
                    <p style="text-align: justify;">Logicspice is an outstanding app development company in Sydney, Australia offers exclusive mobile apps development services such as Hybrid app development, Native app development along with other countries all over the globe. You can hire programmers from us for developing highly featured apps that satisfy customers and users. and serving the app industry since 2006. As per the growing industry, smartphones have become our digital companions. We believe that mobile apps is the most personalized way to connect with your customer. We at logicspice Sydney, transforms your imagination into reality.</p>
                    <p style="text-align: justify;">Our simple designs and unique ideas have placed 4 of our apps in the top 100 on the App Store. Let yours be the 5th.</p>
                    <p style="text-align: justify;">If you have some specific need for your mobile app, then we specialise in Custom mobile app development. So, according to your requirements, we develop mobile application. Firstly, we understand your business, make an appropriate plan for the mobile application then our designers design an innovative and user friendly design for the mobile app, and our expert developers will execute and deploy it.</p>
                </div>
            </div>
            <div class="col-md-4">
