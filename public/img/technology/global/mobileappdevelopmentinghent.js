...
export default{
    ...
    template:`
    <section class="country_header_secton ghent">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="foradd">for</div><div class="country_header_secton_right_countryname">Ghent</div>
        ...
        <div class="row">
            <div class="col-md-8">
                <div class="mobileapp_devcountry_bx_left">
                    <h1 class="mobileapp_devcountry_bx_left_title">Mobile App Development Company In <span>Ghent</span></h1>
