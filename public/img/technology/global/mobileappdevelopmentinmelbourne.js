...
export default{
    ...
    template:`
    <section class="country_header_secton melbourne">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="text-center main-ind-text">
                        ...
                        <div class="foradd">for</div><div class="country_header_secton_right_countryname">Melbourne</div>
                        ...
                        <div class="portfolio_button_center">
                            ...
                            <div id="inquirenow" class="portfolio_button"> 
        <a id="" class="btn btn-primary" @click="openmodelcontactus()"><span>Enquire Now</span></a>     
</div>
                        </div>
                    </div>
        ...
        <div class="row">
            <div class="col-md-8">
                <div class="mobileapp_devcountry_bx_left">
                    <h1 class="mobileapp_devcountry_bx_left_title">Mobile App Development Company In <span>Melbourne</span></h1>
                    <p style="text-align: justify;">Logicspice is one of the best mobile app development company that delivers the best mobile apps in Sydney, Melbourne, Canberra, Albany, Brisbane, Adelaide, Townsville, Gold Coast, Perth, Wollongongand all other major cities of Australia. We have a highly experienced developer team who provide great and successful app to the client at their doorstep. The company is engaged in the deliverance of top-class mobile apps on platforms like iPhone, iPad and Android</p>
                    <p style="text-align: justify;">We offer services to our client from planning to development. Quality is our first priority, our additional features include free technical support. We always believe in giving additional benefits to our client.</p>
                    <p style="text-align: justify;">We specialise in Custom mobile app development to meet your business requirements. Firstly, we understand your business, make an appropriate plan for the mobile application then our designers design an innovative and user friendly design for the mobile app, and our expert developers will execute and deploy it.</p>
                </div>
            </div>
            <div class="col-md-4">
...
<section class="advantages-country">
    <div class="container">
        ...
        <app-contactmodel></app-contactmodel>
    `
}