...
export default{
    ...
    template:`
    <section class="country_header_secton flanders">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="foradd">for</div><div class="country_header_secton_right_countryname">Flanders</div>
        ...
        <div class="row">
            <div class="col-md-8">
                <div class="mobileapp_devcountry_bx_left">
                    <h1 class="mobileapp_devcountry_bx_left_title">Mobile App Development Company In <span>Flanders</span></h1>
...
<section class="acquainted">
    <div class="container">
        <h3 class="mobileapp_devcountry_bx_left_title">We Have Served Our Clients In Belgium</h3>
        <p>Being acquainted with latest technology & standard tools we have delivered thousands of web & mobile application to our clients in Belgium and have a team of 
  ...
  <!-- Wrapper for slides -->
    ...
    <div class="ClientSlideBx">
      <div class="row">
            <div class="col-md-4">
        <img src="./../assets/img/globalpages/9da70_Uuuga.png" alt="..."  class="img-thumbnail">
      </div>
            <div class="col-md-8">
                <h4>Uuuga</h4>
                <p>The application serves as "Online Marketplace Android & iPhone app" which is an entry level app for the buyers. Buyer would be able to upload there CVs and would 
                    be able to capture the video resume or requirement in the form of video and then the buyers CV would be matched as per the requirement and the review of video 
                    resume would be done . If the buyer shortlists the resource
                    <a href="https://www.logicspice.com/case-study/uuuga" target="_blank">Read More..</a></p>
...
<!--                        <div class="left_side_testi">
                        ...
                        <div class="right_side_testi">
                            <div class="quotes_img">
                                <a href="/"><img src="./../assets/img/globalpages/quotes.png" alt="quotes-img"></a>
                            </div>  
                            <div class="cilent_text">
                                "We have worked on several projects with same 5star experience. Great Job!"
                            </div>    
                            <div class="cilent_name">
                                <span><strong class="flag"><img src="./../assets/img/globalpages/belg.png" alt="belgium"></strong> peterbrysse</span>
    ...
    <div class="ClientSlideBx">
      <div class="row">
            <div class="col-md-4">
        <img src="./../assets/img/globalpages/GigMinute.png" alt="..."  class="img-thumbnail">
      </div>
            <div class="col-md-8">
                <h4>Gigminute</h4>
                <p>Gigminute, is an event marketplace website, that will provide a platform to the event planners/hosts and artists (Actors, Musicians, and Speakers) to get in touch 
                    with each other. This website will facilitate event planners and artists to register over the website. Where artists can list themselves with their pictures, 
                    videos (YouTube), and review rating etc. with free
                    <a href="https://www.logicspice.com/case-study/gigminute" target="_blank">Read More..</a></p>
...
<!--                        <div class="left_side_testi">
                            <div class="cilent_img"> 
                                <img src="./../assets/img/globalpages/no-img-client.png" alt="">                            </div> 
                            <div class="cilent_name">
                                <span><strong class="flag"><img src="./../assets/img/globalpages/belg.png"></strong> Gdoli  </span>
                        ...
                        <div class="right_side_testi">
                            ...
                            <div class="cilent_text">
                                "I have been working with Manish and his team for 2 years now. We hire him regularly to improve our platform. The developers are very good and the 
                                codes are clean. So far, they have always been able to meet our requirements and make their best to satisfy us. They should just pay more attention 
                                to design details. I will clearly continue working with them in the future if their prices remain in line with the Market average. We know that we 
                                can trust them and this is a very important point for us. Thanks for the good work, Olivier"
                            </div>  
                            <div class="cilent_name">
                                <span><strong class="flag"><img src="./../assets/img/globalpages/belg.png"></strong> Gdoli  </span>
