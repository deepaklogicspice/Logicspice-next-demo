...
export default{
    ...
    template:`
    <section class="country_header_secton london">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="foradd">for</div><div class="country_header_secton_right_countryname">London</div>
        ...
        <div class="row">
            <div class="col-md-8">
                <div class="mobileapp_devcountry_bx_left">
                    <h1 class="mobileapp_devcountry_bx_left_title">Mobile App Development Company In <span>London</span></h1>
                    <p style="text-align: justify;">Logicspice is one of the world’s leading mobile app development companies. The combination of functionality with best design is our functionality. At Logicspice London, our mobile app developers take your idea and convert it into a stunning mobile app that users will love. Our focus is on product driven apps rather than campaign driven apps.</p>
                    <p style="text-align: justify;">We offer most advance, beautiful and great user experience app. We want to help the client to bring something advance to the world. We want you to use your skills fully.</p>
                </div>
            </div>
            <div class="col-md-4">
