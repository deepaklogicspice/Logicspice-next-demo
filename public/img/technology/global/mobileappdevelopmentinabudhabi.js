...
export default{
    ...
    template:`
    <section class="country_header_secton abudhabi">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="foradd">for</div><div class="country_header_secton_right_countryname">Abu Dhabi</div>
        ...
        <div class="row">
            <div class="col-md-8">
                <div class="mobileapp_devcountry_bx_left">
                    <h1 class="mobileapp_devcountry_bx_left_title">Mobile App Development Company In <span>Abu Dhabi</span></h1>
...
<section class="acquainted">
    <div class="container">
        ...
        <p>Being acquainted with latest technology & standard tools we have delivered thousands of web & mobile application to our clients in Dubai, UAE and have a team of 
